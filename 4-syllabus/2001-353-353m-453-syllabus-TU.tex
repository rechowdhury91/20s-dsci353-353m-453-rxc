...
\chead{Tohoku University, Graduate School of Information Sciencee, Data Science Program: IT Fundamentals, Applied Data Science with R} 
\rhead{}
...
%\title{DSCI353-353M-453 Syllabus \\ \emph{Data Science Modeling, Prediction and Statistical and Machine Learning} \\ Spring 2019 	Tuesday, Thursday 11:30 am to 12:45 pm, 	Nord 356}
...
%For more information see Applied Data Science in the CWRU Bulletin \href{''http://bulletin.case.edu/schoolofengineering/datascience/''}{http://bulletin.case.edu/schoolofengineering/datascience/}, and also the \href{''http://datascience.case.edu/minor''}{http://datascience.case.edu/minor}.  
%
%DSCI353 will introduce students to modeling and prediction, the steps in a data analysis the following data cleaning and exploratory data analysis (the subject of DSCI351-451). 
...
\begin{SCfigure}
	\centering
	\caption{{\bf LRS}: Mark P. J. van der Loo and Edwin de Jonge, {\bf Learning RStudio for R Statistical Computing}. 2012 \cite{mark_learning_2012}}
	\includegraphics[width=0.2\textwidth]%
	{figs/learningrstudioforr.jpg} % picture filename
\end{SCfigure}
...
\subsection{ItFun:ADSwR Textbooks}

See Figure 3, 4 and 5.

\begin{SCfigure}
    \centering
  \caption{{\bf OISv3}: David M. Diez, Christopher D. Barr, and Mine Cetinkaya-Rundel, \href{"https://www.openintro.org/stat/textbook.php"}{ {\bf OpenIntro Statistics 3rd Ed.} } 2015 \cite{diez_openintro_2015} }
  \includegraphics[width=0.2\textwidth]%
...
%\begin{table}[h] 
%	\centering % used for centering table 
%	\begin{tabular}{| c | p{4cm} | p{4cm} | c | c |} % centered columns (5 columns) 
%	\hline %inserts horizontal line
%	Day:Date & Foundation & Practicum  & Reading & Due  \\ % inserts table heading 
%	\hline 
%	\hline % inserts double horizontal line 
%%	 w1\addtolength{}{•}
%  w01a:Tu:1/15/19 & Open Data Science & R, Rstudio IDE, Git &  & \\ % inserting body of the table 
%  \hline %inserts single line 
%  w1b:Th:1/17/19 & Intro R Markdown & Forking Class Repo & (R4DS-1,2,3) & \\ 
%  \hline  
%  \hline
%   W2a:Tu:1/22/19 & Statistical Learning & Pred. Analytics & ISLR2 &  \\ 
%  \hline
%  w2b:Th:1/24/19 &  Lin. Regr. & SemProj, Tidy & (R4DS-4,5,6) & LE1 \\
%  \hline 
%  \hline
%  w3a:Tu:1/29/19 & Lin. Regr. & Pairs Plots & (OIS7) &  \\ 
%  \hline
%  w3b:Th:1/31/19 & Mult. Lin. Regr. & Test Stats & ISLR3 (R4DS-7,8) & \\
%  \hline
%  \hline 
%  w4a:Tu:2/5/19 & Logistic Regr., LDA & Interactions & ISLR4 & LE2 {\bf LE1 Due} \\ 
%  \hline
%  w4b:Th:2/7/19 & Classification & & (OIS8) & \\
%  \hline
%  \hline 
%  w5a:Tu:2/12/19* & Resample Cross-Valid. & Cluster Analysis & DL1,2, ISLR5 &  \\ 
%  \hline
%  w5b:Th:2/14/19 & Bootstrap & Steps of Data Analysis & (R4DS9-16) & {\bf LE2 Due} \\
%  \hline
%  \hline 
%  w6a:Tu:2/19/19 & LMS: Subset &  & DL3,4, ISLR6 & LE3 \\ 
%  \hline
%  w6b:Th:2/21/19 & LMS: Feature Selec. & Coeff. Uncertainties & (R4DS17-21) &  \\
%  \hline
%  \hline 
%  w7a:Tu:2/26/19* & Beyond Lin: Splines GAM & BL: Lab & DL5,6, ISLR7 &  \\ 
%  \hline
%  w7b:Th:2/28/19 & MidTerm Review & SemProj1 & (R4DS22-25) & {\bf LE3 Due} \\
%  \hline
%  \hline 
%  w8a:Tu:3/5/19* & {\bf MIDTERM EXAM} &  & ISLR8 &  \\ 
%  \hline
%  w8b:Th:3/7/19 & Dim. Reduc. \& PCA & SemProj1 & (R4DS26-30) & \\
%  \hline
%  \hline 
%  Tu:Th:3/11-15/19 & {\bf SPRING BREAK} &  & ISLR9 &  \\ 
%  \hline
%  \hline 
%  w9a:Tu:3/19/19 & Regr. Trees & Dec. Trees & ISLR10 & LE4 \\ 
%  \hline 
%  w9b:Th:3/21/19 & Bagging, Boosting & How DT Work &  &  \\
%  \hline
%  \hline
%  w10a:Tu:3/26/19* & Support Vector Mach. & SVM & ESL11 & {\bf LE4 Due}  \\	
%  \hline
%  w10b:Th:3/28/19 & Neural Networks & NN & DLR1 & LE5 \\
%  \hline
%  \hline 
%  w11a:Tu:4/2/19* & ML Overview, Caret & SemProj2 & DLR2 &   \\ 
%  \hline
%  w11b:Th:4/4/19* & NN Topology, Training & SemProj2 &  DLR3 & {\bf LE5 Due} \\
%  \hline
%  \hline 
%  w12a:Tu:4/9/19 & NN Types & CNN w TF & DLR4 & LE6 \\ 
%  \hline
%  w12b:Th:4/11/19 & R-TensorFlow &  &  &  \\
%  \hline
%  \hline 
%  w13a:Tu:4/16/19 & Keras & &  & {\bf LE6 Due} LE7 \\ 
%  \hline
%  w13b:Th:4/18/19 &  & &  &  \\
%  \hline
%  \hline 
%  w14a:Tu:4/23/19 &  & SemProj3 &  &  \\ 
%  \hline
%  w14b:Th:4/25/19 &  & SemProj3 &  & {\bf LE7 Due} \\
%  \hline
%  \hline
%  :  & {\bf FINAL EXAM} & {\bf Thu. May 2, 2019, 12-3pm}  & Nord 356 & \\
%  \hline
%  \hline
%\end{tabular} 
...
\begin{table}[h] 
  ...
  \begin{tabular}{| c | p{4cm} | p{4cm} | c | c |} % centered columns (5 columns) 
    ...
    \hline % inserts double horizontal line 
    %	 w1\addtolength{}{•}
    c01a:We:5/29/19 & Open Data Science & R, Rstudio IDE, Git &  & \\ % inserting body of the table 
    \hline %inserts single line 
...
\subsection{Lectures}
%Spring 2019 	Tuesday, Thursday 11:30 am to 12:45 pm		Nord 356
